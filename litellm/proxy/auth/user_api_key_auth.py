...
async def _run_centralized_common_checks(
    ...
    mapped_internal_user_for_auth: Final = _apply_internal_user_header_mapping_for_auth(
    ...
    if user_api_key_auth_obj.user_role == LitellmUserRoles.PROXY_ADMIN and not mapped_internal_user_for_auth:
...
def _apply_internal_user_header_mapping_for_auth(
    ...
    original_user_id: Final = user_api_key_auth_obj.user_id
    ...
    return user_api_key_auth_obj.user_id is not None and user_api_key_auth_obj.user_id != original_user_id
